...
const App: React.FC = () => {
  ...
  const connectWebSocket = () => {
    return new Promise<void>((resolve) => {
      ...
      // const socket = new WebSocket("ws://localhost:8080/ws/speech");
      // const socket = new WebSocket("wss://ec2-13-200-222-241.ap-south-1.compute.amazonaws.com:8080/ws/speech")
      const socket = new WebSocket("wss://streaming-mhz5.onrender.com/ws/speech")
